            ...
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <?php else: ?>
                            ...
                            <li><a href="/user/register" class="footer-link">Sign Up</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/legal/about" class="footer-link">About Us</a></li>
                        <li><a href="/legal/contact" class="footer-link">Contact</a></li>
                    </ul>
                </div>
            </div>
